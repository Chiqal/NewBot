...
cl = LINETCR.LINE()
cl.login(token="EnjIdcbGR8nwz2GXkWW9.fbMcAjl5m9eOdy9zPiwPkq.ae8xEhgvvHQ5MJZ/JDKCukvqhMXkFxmDYLa5QhAV5KI=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnP1wTwwXY0jfdoET52a.jRtusaIE4DcH+SxjLmsK6G.SwR+1lGpydLA9PGy763NZ62A0d7NHz2RLRe0+LCe8TI=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EnEJAVkbX9hiMwoVfQp0.EaAcuovi80UBqbkxEcw4ia.6LFkdV6Nxo2XAliennWZidOVzXpjQ62lmgwOXHj3kLk=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EnbC0qbWCLSiEupg0hT6.eplTeWyMNHFdEPB9X26hDG.rkPNaZ64hV2jUgljhInxEHfBLSuMvZ3lyIZleU71Rqw=")
kc.loginResult()
...
def bot(op):
    try:
        ...
        if op.type == 26:
               ...
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv1 ourl","1link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv2 ourl","2link on"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Cv3 ourl","3link on"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv1 curl","1link off"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Cv2 curl","2link off"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv3 curl","3linkoff"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
...
#-----------------------------------------------
            	...
            	cl.sendText(msg.to,"🆗8⃣6⃣")
                ki.sendText(msg.to,"8⃣6⃣")
                kk.sendText(msg.to,"8⃣6⃣")
                kc.sendText(msg.to,"8⃣6⃣")
#-----------------------------------------------
            elif "Bc " in msg.text:
...
#------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"FUCK YOU")
                    ki.sendText(msg.to,"Jangan balik lagi ya")
                    kk.sendText(msg.to,"papaaaaaayy")
                    kc.sendText(msg.to,"See you darling 😘😘😘")
